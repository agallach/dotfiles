...
#+begin_src elisp
(setq user-full-name "agallach"
      user-mail-address "121731919+agallach@users.noreply.github.com")
#+end_src
...
See =lang/org/config.el= for doom's evil-org-mode and org-mode keybindings.
